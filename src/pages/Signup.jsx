...
export default function Signup() {
  ...
  return (
    <div className=" bg-gradient-to-br from-#DDF6D2 to-white relative font-space" style={{overflow: 'hidden'}}>
      ...
      {/* Main Content */}
      <div className="relative z-10 h-screen" style={{overflow: 'hidden'}}>
        {/* Desktop Layout */}
        <div className="hidden lg:grid lg:grid-cols-2 lg:h-screen">
          ...
          <div className="flex items-center justify-center p-6 xl:p-12 h-full overflow-hidden">
            <div className="w-full max-w-md">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-bold text-gray-900">Create Account</h2>
                  <p className="text-gray-600 mt-2">Join the MCA community</p>
                </div>
